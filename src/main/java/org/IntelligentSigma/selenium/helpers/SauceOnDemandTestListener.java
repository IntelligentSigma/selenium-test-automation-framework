...
/*
 * Test Listener that provides helper logic for TestNG tests.  Upon startup, the class  will store any SELENIUM_*
 * environment variables (typically set by a Sauce OnDemand CI plugin) as system parameters, so that they can be
 * retrieved by tests as parameters.
 *
 * TODO This listener was provided to help set up a variety of helpers, including how to re-run failed tests. It isn't,
 * TODO at this time, working.
 * TODO We also wanted to be able to specify whether to download log/video from SauceLabs
 *
 */
public class SauceOnDemandTestListener extends TestListenerAdapter {
    ...
    /*
     * The underlying {@link com.saucelabs.common.SauceOnDemandSessionIdProvider} instance which contains the Selenium
     * session id.  This is typically the unit tests being executed.
     */
    ...
    public void onTestStart(ITestResult result) {
      ...
      DriverHelper driverHelper = new DriverHelper();
        ...
        if (result.getInstance() instanceof SauceOnDemandAuthenticationProvider) {
            //use the authentication information provided by the tests class
        ...
        this.sauceREST = new SauceREST(driverHelper.getSauceUserName(), driverHelper.getSauceUserKey());
    }
